      ...
      <div id="carouselExampleControls" class="carousel slide " data-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="img-box">
              <img src="media/images/slider-img.png" alt="">
            </div>
          </div>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex  flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="controller/sobre.php">Sobre </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="controller/produtos.php">Produtos </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="controller/metas.php">Metas</a>
                </li>
                <li class="nav-item">
  ...
  <section class="shop_section layout_padding">
    <div class="container">
      <div class="box">
        ...
        <div class="img-box">
          <img src="media/images/shop-img.png" alt="">
        </div>
        <div class="btn-box">
          <a href="">Comprar</a>
        </div>
        ...
        <div class="col-md-5">
          <div class="detail-box">
            <div class="heading_container">
              <hr>
              <h2>Sobre All Instruments</h2>
            </div>
            <p>Objetivo, compromisso social, diferencial</p>
            <a href="">Ler mais</a>
          </div>
        </div>
      </div>
